...
// 备注信息     
//-------------------------------------------------------------------------------------------------------------------
//void ble6a20_read_data (uint8 *buff)
//{
//    zf_assert(NULL != buff);
//	  uint32 fifo_data_count = 0; 
//	  char data_buffer[64] = {0};
//	  fifo_data_count = fifo_used(&ble6a20_fifo);
//		if (fifo_data_count > 0) 
//		{
//			fifo_read_buffer(&ble6a20_fifo, buff, &fifo_data_count, FIFO_READ_AND_CLEAN);
//			snprintf(data_buffer, sizeof(data_buffer), 
//				"receive:%d\r\n",
//				buff);
//			ble6a20_send_string(buff);			
//		}
//}
