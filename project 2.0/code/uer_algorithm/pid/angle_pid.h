...
/*
 * Heading-hold outer-loop helper.
 *
 * Input/return unit:
 ...
 *
 * New motion execution should use angle_pid_calc_output() as a Vz correction
 * before mecanum inverse kinematics and wheel speed PID.
 */
